...
export function GroupConversation({ group, onBack, onLeave }: GroupConversationProps) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-background z-[200]">
      ...
      {/* Input */}
      <div className="flex-shrink-0 px-2 py-2 bg-black/30 backdrop-blur-xl border-t border-white/10 safe-area-bottom">
        <div className="flex items-center gap-2">
          ...
          <div className="flex-1">
            <input
              ...
              className="w-full h-11 px-4 rounded-full bg-white/10 backdrop-blur-md text-white placeholder:text-white/40 outline-none focus:ring-1 focus:ring-[#6ab3f3]/30 transition-all border border-white/10"
            />
          </div>
