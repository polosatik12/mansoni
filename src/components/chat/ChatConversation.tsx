...
export function ChatConversation({ conversationId, chatName, chatAvatar, otherUserId, onBack, participantCount, isGroup, totalUnreadCount, onRefetch }: ChatConversationProps) {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-background z-[200]">
      ...
      <div className="flex-shrink-0 bg-black/40 backdrop-blur-2xl border-t border-white/20 shadow-lg shadow-black/20 safe-area-bottom">
          ...
          {isRecording ? (
            <div className="flex items-center gap-2">
              <button 
                ...
                className="w-11 h-11 rounded-full bg-white/15 backdrop-blur-xl border border-white/20 flex items-center justify-center shrink-0"
              >
                <X className="w-5 h-5 text-white/70" />
              </button>
              
              <div className="flex-1 flex items-center gap-3 h-11 px-4 rounded-full bg-white/15 backdrop-blur-xl border border-white/20">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full h-11 px-4 pr-12 rounded-full bg-white/15 backdrop-blur-xl text-white placeholder:text-white/50 outline-none focus:ring-2 focus:ring-white/30 transition-all border border-white/20"
                />
