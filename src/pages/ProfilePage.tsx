  ...
  if (profileLoading) {
    return (
      <div className="min-h-screen relative overflow-hidden">
        {/* Aurora Background - brighter in light mode */}
        <div className="fixed inset-0 bg-gradient-to-br from-violet-200 via-purple-300 to-fuchsia-200 dark:from-slate-900 dark:via-purple-900/80 dark:to-slate-900">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-400/50 dark:bg-cyan-500/30 rounded-full blur-3xl animate-pulse" />
          <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-blue-400/40 dark:bg-blue-500/25 rounded-full blur-3xl animate-pulse delay-1000" />
          <div className="absolute bottom-1/4 left-1/3 w-72 h-72 bg-violet-400/50 dark:bg-violet-500/30 rounded-full blur-3xl animate-pulse delay-500" />
          <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-pink-400/40 dark:bg-pink-500/20 rounded-full blur-3xl animate-pulse delay-700" />
        </div>
