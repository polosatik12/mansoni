...
export function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 bg-card/80 dark:bg-card backdrop-blur-md sticky top-0 z-20">
        <div className="w-10" />
      ...
      {/* Profile Info Row */}
      <div className="px-4 py-4 bg-card/80 dark:bg-transparent backdrop-blur-md">
      ...
      {/* Content Tabs */}
      <div className="sticky top-[52px] z-10 bg-card/90 dark:bg-card backdrop-blur-md">
        <div className="flex">
          {tabs.map((tab) => {
            const Icon = tab.icon;
